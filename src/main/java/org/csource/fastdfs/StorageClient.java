...
public class StorageClient {
	 ...
	 */
	public String[] upload_file(String group_name, String master_filename, String prefix_name, byte[] file_buff,
			int offset, int length, String file_ext_name, NameValuePair[] meta_list) throws Exception {
		if ((group_name == null || group_name.length() == 0)
				|| (master_filename == null || master_filename.length() == 0) || (prefix_name == null)) {
			throw new MyException("invalid arguement");
		}
	...
	public String[] upload_file(String group_name, String master_filename, String prefix_name, long file_size,
			UploadCallback callback, String file_ext_name, NameValuePair[] meta_list) throws Exception {
		return this.do_upload_file(ProtoCommon.STORAGE_PROTO_CMD_UPLOAD_SLAVE_FILE, group_name, master_filename,
	...
	public int modify_file(String group_name, String appender_filename, long file_offset, String local_filename)
		...
		try {
			return this.do_modify_file(group_name, appender_filename, file_offset, f.length(),
	...
	public int modify_file(String group_name, String appender_filename, long file_offset, byte[] file_buff)
			throws Exception {
		return this.do_modify_file(group_name, appender_filename, file_offset, file_buff.length,
				new UploadBuff(file_buff, 0, file_buff.length));
	}
	 ...
	 */
	public int modify_file(String group_name, String appender_filename, long file_offset, byte[] file_buff,
			int buffer_offset, int buffer_length) throws Exception {
		return this.do_modify_file(group_name, appender_filename, file_offset, buffer_length,
	...
	protected String[] do_upload_file(byte cmd, String group_name, String master_filename, String prefix_name,
		...
		try {
			...
			int result = 0;
			try {
				result = this.set_metadata(new_group_name, remote_filename, meta_list,
			...
			if (!bNewConnection) {
				try {
					...
					logger.error("Failed to close storageServer", ex1);
				} finally {
					this.storageServer = null;
				}
			}
	 ...
	 * @throws Exception 
	 */
	public int delete_file(String group_name, String remote_filename) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public int truncate_file(String group_name, String appender_filename) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public byte[] download_file(String group_name, String remote_filename) throws Exception {
	 ...
	 * @throws Exception 
	 */
	public NameValuePair[] get_metadata(String group_name, String remote_filename) throws Exception {
		boolean bNewConnection = this.newUpdatableStorageConnection(group_name, remote_filename);
		Socket storageSocket = this.storageServer.getSocket();
	 ...
	 * @throws Exception 
	 */
	public FileInfo get_file_info(String group_name, String remote_filename) throws Exception {
		...
		if (((remote_filename.length() > ProtoCommon.TRUNK_LOGIC_FILENAME_LENGTH)
				...
				|| ((file_size & ProtoCommon.APPENDER_FILE_SIZE) != 0)) { // slave
																			// file
																			// or
																			// appender
																			// file
	 ...
	 * @throws Exception 
	 */
	public FileInfo query_file_info(String group_name, String remote_filename) throws Exception {
		boolean bNewConnection = this.newUpdatableStorageConnection(group_name, remote_filename);
		Socket storageSocket = this.storageServer.getSocket();
	 ...
	 * @throws Exception 
	 */
	protected boolean newWritableStorageConnection(String group_name) throws Exception {
	 ...
	 * @throws Exception 
	 */
	protected void send_package(byte cmd, String group_name, String remote_filename) throws Exception {
		byte[] header;
		byte[] groupBytes;
		byte[] filenameBytes;
		byte[] bs;
